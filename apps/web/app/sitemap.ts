...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const routes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/sessions`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${base}/sessions/morning-peace`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/sessions/healing-at-midday`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/sessions/evening-rest`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/sessions/faith-for-the-week`, lastModified: now, changeFrequency: "monthly", priority: 0.6 },
