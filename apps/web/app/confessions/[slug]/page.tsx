 ...
 * Confession detail.
 *
 * The route segment is named `slug` for URL stability in the site map, but it
 * resolves by the confession id — GET /confessions/{id} is the only detail
 * endpoint the API serves, and ids are what every card links with. Slug text
 * for confessions is a backend gap that predates this page (recorded in
 * docs/44-WEB-PLATFORM-AUDIT.md §5); until the API serves by slug, accepting
 * one here would be a promise the page cannot keep.
 *
