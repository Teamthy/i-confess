...
func main() {
    ...
    _, err = conn.Exec("INSERT INTO voices (id,name,description,type,provider,gender,language,premium,status,created_at,updated_at) VALUES ('v1','test','','professional','', '', 'en',0,'active','2024-01-01T00:00:00Z','2024-01-01T00:00:00Z')")
    if err != nil { panic(err) }
    _, err = conn.Exec("INSERT INTO categories (id,name,slug,description,icon,premium,status,sort_order,created_at,updated_at) VALUES ('c1','cat','cat','','',0,'published',0,'2024-01-01T00:00:00Z','2024-01-01T00:00:00Z')")
    if err != nil { panic(err) }
