...
func TestTokenRoleValidation(t *testing.T) {
	...
	tests := []struct {
		...
		{"empty role (user)", "", false},
		{"super_admin role", RoleSuperAdmin, true},
		{"content_admin role", RoleContentAdmin, true},
		{"audio_producer role", RoleAudioProducer, true},
		{"theological_reviewer role", RoleTheologicalRev, true},
		{"support_admin role", RoleSupportAdmin, true},
		{"analytics_admin role", RoleAnalyticsAdmin, true},
